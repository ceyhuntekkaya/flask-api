...
from project.repository.constant.preference import PreferenceRepository
...
class PreferenceService:
    ...
    def __init__(self, session: Session):
        ...
        self.repo = PreferenceRepository(session, PreferenceModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = PreferenceModel(**item_data)
