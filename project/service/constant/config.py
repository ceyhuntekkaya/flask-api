...
from project.repository.constant.config import ConfigRepository
...
class ConfigService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, ConfigModel)
        self.repo = ConfigRepository(session, ConfigModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = ConfigModel(**item_data)
