...
from project.repository.constant.command import CommandRepository
...
class CommandService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, CommandModel)
        self.repo = CommandRepository(session, CommandModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = CommandModel(**item_data)
