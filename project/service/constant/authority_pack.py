...
from project.repository.constant.authority_pack import AuthorityPackRepository
...
class AuthorityPackService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, AuthorityPackModel)
        self.repo = AuthorityPackRepository(session, AuthorityPackModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = AuthorityPackModel(**item_data)
