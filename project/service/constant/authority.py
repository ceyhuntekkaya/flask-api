...
from project.repository.constant.authority import AuthorityRepository
...
class LayerService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, AuthorityModel)
        self.repo = AuthorityRepository(session, AuthorityModel)
