...
from project.repository.constant.command_collar_mark_rank import CommandCollarMarkRankRepository
import project.service.converters as Converter
from project.exception.entity_not_found import EntityNotFoundException
from project.exception.unexpected_entity import UnexpectedEntityException


class CommandCollarMarkRankService:
    session: Session = NotImplementedError

    def __init__(self, session: Session):
        super().__init__(session, CommandCollarMarkRankModel)
        self.repo = CommandCollarMarkRankRepository(session, CommandCollarMarkRankModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = CommandCollarMarkRankModel(**item_data )
