...
from project.repository.constant.hierarchy import HierarchyRepository
...
class HierarchyService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, HierarchyModel)
        self.repo = HierarchyRepository(session, HierarchyModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = HierarchyModel(**item_data)
