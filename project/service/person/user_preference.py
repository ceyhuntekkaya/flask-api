...
from project.repository.person.user_preference import UserPreferenceRepository
...
class UserPreferenceService:
    ...
    def __init__(self, session: Session):
        ...
        self.repo = UserPreferenceRepository(session, UserPreferenceModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = UserPreferenceModel(**item_data )
