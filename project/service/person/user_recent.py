...
from project.repository.person.user_recent import UserRecentRepository
...
class UserRecentService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, UserRecentModel)
        self.repo = UserRecentRepository(session, UserRecentModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = UserRecentModel(**item_data )
