...
from project.repository.person.user_authority import UserAuthorityRepository
...
class UserAuthorityService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, UserAuthorityModel)
        self.repo = UserAuthorityRepository(session, UserAuthorityModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = UserAuthorityModel(**item_data)
