...
from project.models.material.symbol import SymbolModel
from project.repository.material.symbol import SymbolRepository
...
class SymbolService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, SymbolModel)
        self.repo = SymbolRepository(session, SymbolModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = SymbolModel(**item_data)
