...
from project.models.library.screenshot import ScreenshotModel
from project.repository.library.screenshot import ScreenshotRepository
...
class ScreenshotService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, ScreenshotModel)
        self.repo = ScreenshotRepository(session, ScreenshotModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = ScreenshotModel(**item_data)
