...
from project.repository.library.media import MediaRepository
...
class LayerService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, MediaModel)
        self.repo = MediaRepository(session, MediaModel)
