...
from project.repository.library.media_source import MediaSourceRepository
...
class LayerService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, MediaSourceModel)
        self.repo = MediaSourceRepository(session, MediaSourceModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = MediaSourceModel(**item_data)
