...
from project.models.map.map import MapModel
from project.repository.map.map import MapRepository
...
class MapService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, MapModel)
        self.repo = MapRepository(session, MapModel)
