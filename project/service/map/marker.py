...
from project.models.map.marker import MarkerModel
from project.repository.map.marker import MarkerRepository
...
class LayerService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, MarkerModel)
        self.repo = MarkerRepository(session, MarkerModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = MarkerModel(**item_data )
