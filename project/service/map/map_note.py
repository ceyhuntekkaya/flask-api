...
from project.models.map.map_note import MapNoteModel
from project.repository.map.map_note import MapNoteRepository
...
class MapNoteService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, MapNoteModel)
        self.repo = MapNoteRepository(session, MapNoteModel)
    ...
    def add(self, item_data, created_by):
        ...
        new_item = MapNoteModel(**item_data )
