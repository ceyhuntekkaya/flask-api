...
from project.repository.log.log import LogRepository
...
class LogService:
    ...
    def __init__(self, session: Session):
        super().__init__(session, LogModel)
        self.repo = LogRepository(session, LogModel)
