...
from project.service.constant.command_collar_mark import CommandCollarMarkService
...
main_route = "command_collar_mark"
...
class WithId(MethodView):
    ...
    def get(self, item_id):
        service = CommandCollarMarkService(db.session)
